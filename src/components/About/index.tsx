        ...
        <AboutContainer id="sobre">
            <AboutContent>
                ...
                <SocialIconsContainer data-aos="zoom-in" data-aos-duration="1000">
                    ...
                    <SocialIconLink href="https://www.linkedin.com/in/ronald-oliveira77/" target="_blank" className="linkedin">
                        <i className="fab fa-linkedin"></i>
                        <span>LinkedIn</span>
                    </SocialIconLink>
                    <SocialIconLink href="https://www.instagram.com/ronald_oliveira_1/" target="_blank" className="instagram">
